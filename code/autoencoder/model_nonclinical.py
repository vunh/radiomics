...
class CAE_3D(object):
    ...
    def train(self, args):
        ...
        print "No. testing data: ", (len(self.X_val) // self.batch_size), self.X_val.shape[0];
    ...
    def generator(self, image):
        with tf.variable_scope("generator") as scope:
            ...
            net['conv2'] = lrelu(conv3d(net['pool1'], self.gf_dim/4, name='g_conv2'));
            ...
            net['fc1'] = conv3d(net['pool2'], self.gf_dim*8, k_d=16, k_h=32, k_w=32, pad_='VALID', name='g_fc1');
            print "fc1 dim ", net['fc1'].get_shape();
            #net['fc2'] = self.g_bn_e6(conv3d(net['fc1'], 1, k_d=1, k_h=1, k_w=1, pad_='VALID', name='g_fc2'));
            net['fc2'] = conv3d(net['fc1'], 1, k_d=1, k_h=1, k_w=1, pad_='VALID', name='g_fc2');
    ...
    def load_data(self, dir_list, mu=None, sigma=None):
        ...
        return X_loaded, Y_loaded, mu, sigma;
